...
public class PhoneBook {
	...
	protected DataBindingContext initDataBindings() {
		...
		IObservableMap[] observeMaps = BeansObservables.observeMaps(listContentProvider_1.getKnownElements(), Person.class, new String[]{"name", "email", "phone", "mobilePhone1", "mobilePhone2"});
		...
		bindingContext.bindValue(personViewerNameObserveDetailValue, observeTextNameTextObserveWidget, null, null);
		//
